...
const IndexPage = () => (
  <Layout>
    ...
    <Expando>Most of what I do is collaborative and behind the scenes, like <ExpandText triggerText="this">the code wired into the nytimes.com home page on presidential debate nights that allows editors to curate up-to-the-minute photos and video in its centerpiece. Nights like these, I'm shoulder-to-shoulder with those editors in the nerve center of the newsroom to guard against unforeseen bugs and errant captions.</ExpandText>
    <ExpandText triggerText="this." before=" and "><span>Another example is</span> the interactive template I built for The Real Estate section's weekly column <em>The Hunt</em>, where readers can get an intimate understanding of New York's bonkers housing market by playing a quiz game weaved into the narrative. Gamifying the column has helped Real Estate find more habitual readers.</ExpandText></Expando>
